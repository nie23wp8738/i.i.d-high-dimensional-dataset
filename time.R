...
# BS1996.TS.NABT (Test statistic based on Bai and Saranadasa)
average_time_BS1996_TS_NART <- run_test_10_times(BS1996.TS.NABT, group1, group2)
cat("Average time for BS1996.TS.NABT: ", average_time_BS1996_TS_NART, " seconds\n")
